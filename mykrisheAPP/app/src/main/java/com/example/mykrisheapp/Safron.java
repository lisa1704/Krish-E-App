...
public class Safron extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel,MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, MovieViewHolder>(
                ...
                mDatabaseReference.child("Products").child("Safron").getRef()
        ) {
            @Override
            protected void populateViewHolder(final MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Safron.this,IndividualProduct.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Safron.this,Cart.class));
        finish();
    }
    ...
    public void Notifications(View view) {
        startActivity(new Intent(Safron.this,NotificationActivity.class));
        finish();
    }
