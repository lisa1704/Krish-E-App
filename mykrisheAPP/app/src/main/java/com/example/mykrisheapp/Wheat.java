...
public class Wheat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel,MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, MovieViewHolder>(
                ...
                mDatabaseReference.child("Products").child("Wheat").getRef()
        ) {
            @Override
            protected void populateViewHolder(final MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Wheat.this,IndividualProduct.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(Wheat.this,Cart.class));
        finish();
    }
    ...
    public void Notifications(View view) {
        startActivity(new Intent(Wheat.this,NotificationActivity.class));
        finish();
    }
